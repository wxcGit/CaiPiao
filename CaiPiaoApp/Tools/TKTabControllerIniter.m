...
+(NSArray<UIViewController *> *)viewControllersWithItems:(NSArray *)items
{
    ...
    for (TKTabControllerItem *item in items) {
        ...
        if (item.titleNormalColor) {
            [tabbarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:item.titleNormalColor} forState:UIControlStateNormal];
        }
        if (item.titleSelectedColor) {
            [tabbarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:item.titleSelectedColor} forState:UIControlStateSelected];
        }
